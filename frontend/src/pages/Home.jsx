...
function Home() {
  ...
  utterance.lang = "en-US"; // ✅ stick to English

  // optional: try to pick an English voice if available
  ...
  synth.cancel(); // stop old speech before starting new
  ...
  return (
    <div className="w-full h-[100vh] bg-gradient-to-t from-[black] to-[#02023d] flex justify-center items-center flex-col gap-[15px] overflow-hidden">
      ...
      >
        ...
        />
        <button
          className="min-w-[160px] h-[60px]  text-black font-semibold   bg-white rounded-full cursor-pointer text-[19px] "
